...
interface HTTPEngine
{
     ...
     * @param string $outFile      OPTIONAL - If $outFile is set, the response will
     *                                  be written to this file instead of StdOut.
     * @param array  $arrayKey     OPTIONAL - Will return all data on a specific
     *                                  array key of the response.
